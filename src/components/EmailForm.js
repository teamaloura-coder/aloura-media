  ...
  return (
    <div>
      <form className="email-form" onSubmit={handleSubmit}>
        ...
        <p>
          We never share your email. By signing up you agree to receive occasional messages from Aloura Media.
        </p>
      ...
      <section className="pricing-section">
        ...
        <a href="https://www.instagram.com/helloaloura/?next=%2F" className="dm-button">DM to Qualify</a>
      </section>
    </div>
  );
}
